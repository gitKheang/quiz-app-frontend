...
// --- minimal logic for admin gating (no UI change) ---
  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-white shadow-md">
      <div className="flex items-center gap-4">
        ...
        {/* Admin link only when role === ADMIN (from Prisma Studio) */}
        {isAdmin(user) && (
      ...
      <div className="flex items-center gap-4">
        {/* fixed routes: /signin and /signup (no UI change) */}
        <Link
          to="/signin"
        ...
        <Link
          to="/signup"
          className="px-4 py-2 text-sm text-primary border border-primary rounded-md hover:bg-primary-light"
        >
          Sign Up
        </Link>
      </div>
