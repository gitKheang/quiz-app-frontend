    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Button
          ...
          className={cn(
            'shrink-0 p-2 h-auto',
            isFlagged ? 'text-warning hover:text-warning/80' : 'text-muted-foreground'
          )}
              ...
              return (
                ...
                >
                  <Checkbox
                    id={option.id}
                    checked={isSelected}
                    onCheckedChange={(checked) => handleMultiChoice(option.id, checked as boolean)}
                    className="mt-0.5 shrink-0"
                  />
                  <Label
                    htmlFor={option.id}
      ...
      <div className="sr-only" aria-live="polite">
        {selectedOptions.length > 0 && (
          <span>
            Answer selected for question {questionNumber}
          </span>
        )}
        {isFlagged && (
