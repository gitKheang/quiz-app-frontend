...
export const mockCategories: CategoryDTO[] = [
  ...
  },
  {
    ...
    slug: 'geography',
    description:
      'Countries, capitals, landmarks, and physical geography',
    color: '#F59E0B',
    icon: '🌍',
    questionCount: 0,
  },
  ...
  },
  {
    ...
    slug: 'sports',
    description:
      'Sports trivia, records, athletes, and major competitions',
    color: '#06B6D4',
    icon: '⚽',
    questionCount: 0,
  },
...
const names = [
  ...
  'David Park', 'Lisa Wang', 'James Miller', 'Maya Patel',
  "Ryan O'Connor", 'Zoe Adams', 'Kevin Lee', 'Anna Garcia',
  'Tom Wilson', 'Sophie Martin', 'Jake Brown', 'Aria Singh',
];
...
export const generateLeaderboardData = (
  ...
  for (let i = 0; i < limit; i++) {
    ...
    if (range === 'daily') {
      ...
      submittedAt.setDate(submittedAt.getDate() - Math.floor(Math.random() * 365));
    }
  ...
  return entries
    .sort((a, b) => (a.score !== b.score ? b.score - a.score : a.timeSec - b.timeSec))
