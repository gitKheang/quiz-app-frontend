              ...
              <div className="space-y-4">
                ...
                <div className="rounded-lg bg-muted/20 p-4 text-[13px] leading-6 text-muted-foreground/80 font-light">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      <b className="font-medium text-foreground/90">difficulty</b>:{" "}
                      <code>easy</code> | <code>medium</code> | <code>hard</code>{" "}
                      <span className="text-muted-foreground/70">(optional; defaults to </span>
                      <code>medium</code>
                      <span className="text-muted-foreground/70">)</span>
                    </li>
                    <li>
                      <b className="font-medium text-foreground/90">options</b>: pipe-separated, e.g.{" "}
                      <code className="px-1 rounded bg-muted/40">2 | 3 | 5 | 8</code>
                    </li>
                    <li>
                      <b className="font-medium text-foreground/90">correct</b>: 1-based positions, pipe-separated for multi, e.g.{" "}
                  ...
                  <div className="mt-3 flex flex-wrap gap-3">
                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        (ws as any)["!cols"] = [{ wch: 60 }, { wch: 12 }, { wch: 14 }, { wch: 48 }, { wch: 14 }];
      ...
      <div className="space-y-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {((question as any).difficulty) && (
                      <Badge variant="secondary">{(question as any).difficulty}</Badge>
                    )}
        ...
        {selectedCategory && questions.length === 0 && (
          <Card className="quiz-card p-6 text-center text-muted-foreground">
            No questions in this category yet. Click <b>New Question</b> to add one.
          </Card>
        )}
      </div>
    </>
