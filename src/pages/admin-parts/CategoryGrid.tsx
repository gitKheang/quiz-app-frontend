...
export default function CategoryGrid({ categories, isLoading, onCreate, onEdit, onDelete }: Props) {
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{category.questionCount} questions</p>
                    </div>
                  </div>
      ...
      <AlertDialog open={!!categoryToDelete} onOpenChange={(open) => !open && setCategoryToDelete(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the category "{categoryToDelete?.name}"? This action cannot be undone and
              will remove all questions in this category.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
