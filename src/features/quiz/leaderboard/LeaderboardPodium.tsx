...
export default function LeaderboardPodium({ leaderboard }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <Card className={cn("quiz-card text-center h-full", getRankRowClass(2))}>
      ...
      >
        <Card className={cn("quiz-card text-center h-full relative", getRankRowClass(1))}>
          ...
          <div className="space-y-3 pt-2">
            ...
            <Badge className="mb-2 quiz-gradient-hero text-white border-0">#1</Badge>
      ...
      >
        <Card className={cn("quiz-card text-center h-full", getRankRowClass(3))}>
          <div className="space-y-3">
            <div className="text-4xl mb-2">🥉</div>
