  ...
  return (
    ...
    >
      <div className="relative">
        <div className={cn("text-8xl font-bold mb-4", getScoreColor(results.score))}>{results.score}%</div>
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm text-muted-foreground">
        ...
        {typeof results.rank === "number" && <Badge variant="outline">Rank #{results.rank}</Badge>}
      </div>
    </motion.div>
  )
}
