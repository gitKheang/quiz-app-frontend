      ...
      >
        <Card className="quiz-card text-center">
          <div className="space-y-3">
            ...
            <div>
              <div className="text-2xl font-bold text-red-600">{results.incorrectCount || 0}</div>
      ...
      >
        <Card className="quiz-card text-center">
          <div className="space-y-3">
            ...
            <div>
              <div className="text-2xl font-bold text-orange-600">{results.unselectedCount || 0}</div>
              <div className="text-sm text-muted-foreground">Unselected Answers</div>
            </div>
          </div>
        </Card>
      </motion.div>
      ...
      >
        <Card className="quiz-card text-center">
          <div className="space-y-3">
            ...
            <div>
              <div className="text-2xl font-bold">{formatTime(results.timeTakenSec)}</div>
